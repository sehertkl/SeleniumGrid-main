...
public class DriverManage {
    ...
    public WebDriver setUpChromeDriver() {
        ...
        try {
            driver = new RemoteWebDriver(new URL("http://192.168.1.41:4444"), chromeOptions);
    ...
    public WebDriver setUpFirefoxDriver() throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.1.41:4444"), firefoxOptions);
    ...
    public WebDriver RemoteEdgeDriver(){
      ...
      //  capabilities.setVersion("121.0.2277.128");
        ...
        try {
            driver= new RemoteWebDriver(new URL("http://192.168.1.41:4444"), edgeOptions);
        } catch (MalformedURLException e) {
            throw new RuntimeException(e);
        }
